...
While performance may vary depending on user settings and available resources, I found the configuration (CPU=6, RAM=64, SSD=200, preemptible=3) to be the most reliable and cost-effective based on my tests.
